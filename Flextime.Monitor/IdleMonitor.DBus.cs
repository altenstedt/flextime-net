...
// on a Fedora 40 Workstation system.
...
namespace Inhill.Flextime.Monitor
{
    ...
    partial class Profiler : IdleMonitorObject
    {
        ...
        { }
        public Task StartAsync(Dictionary<string, Variant> options, SafeHandle fd)
        {
            return this.Connection.CallMethodAsync(CreateMessage());
            MessageBuffer CreateMessage()
            {
    ...
    partial class ServiceChannel : IdleMonitorObject
    {
        ...
        { }
        public Task<SafeHandle?> OpenWaylandServiceConnectionAsync(uint serviceClientType)
        {
